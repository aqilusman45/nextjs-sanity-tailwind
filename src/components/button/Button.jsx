  ...
  if (onClick) {
    return (
      ...
      >
        ...
        {withIconWhite &&
          (mode === "light" ? (
            <ArrowRightWhite className="group-hover:translate-x-1  transition-all duration-400 ease-out translate-x-0 translate-y-[3px]" />
          ) : (
            <ArrowRightDark className="group-hover:translate-x-1  transition-all duration-400 ease-out translate-x-0 translate-y-[3px]" />
          ))}
        {withIconBlue &&
          (mode === "light" ? (
            <ArrowRightBlue className=" group-hover:translate-x-1  transition-all duration-400 ease-out translate-x-0 translate-y-[3px]" />
          ) : (
            <ArrowRightGreen className=" group-hover:translate-x-1  transition-all duration-400 ease-out translate-x-0 translate-y-[3px]" />
          ))}
        {withIconTextLink &&
          (mode === "light" ? (
            <ArrowRightBlue className=" group-hover:translate-x-1  transition-all duration-400 ease-out translate-x-0 translate-y-[3px]" />
