...
export const AddModuleButton = ({
  ...
  return (
    ...
    >
      <Stack
        space={1}
        className="border-storage-medium-light bg-storage-light hover:bg-storage-medium-dark group rounded-sm border text-black transition-all duration-200 hover:text-white hover:duration-75"
      >
        <Box
          className="border-storage-medium-light relative border-b bg-white"
          paddingX={3}
        >
